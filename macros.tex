...
\nc\hrefc[2]{\textcolor{darkblue}{\href{#1}{#2}}}
...
% For arrow notation:  pat <- arr -< exp
\nc\leftarrowTailForArrow{\mathbin{-\!\!\!\prec}}
%% a nicer match than \leftarrow
\nc\leftarrowForArrow{\mathbin{\prec\!\!\!\!\mbox{---}}}
